 ...
 */
public class FormInputPenjualan extends javax.swing.JFrame {

    /**
     * Creates new form LineChartPenjualan
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormInputPenjualan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormInputPenjualan().setVisible(true);
            }
        });
    }
